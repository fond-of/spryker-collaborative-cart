...
use Exception;
use FondOfSpryker\Zed\CollaborativeCart\Business\Exception\QuoteCouldNotBeReleasedException;
...
class CartReleaser implements CartReleaserInterface
{
     ...
     * @param \Generated\Shared\Transfer\ReleaseCartRequestTransfer $releaseCartRequestTransfer
     *
     * @throws \FondOfSpryker\Zed\CollaborativeCart\Business\Exception\QuoteCouldNotBeReleasedException
     *
